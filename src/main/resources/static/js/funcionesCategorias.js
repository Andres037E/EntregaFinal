function traerInformacionCategorias() {
    console.log("test");
    $.ajax({
        url: "http://144.22.56.221:8080/api/Category/all",
        type: "GET",
        datatype: "JSON",
...
function guardarInformacionCategorias() {
    ...
    if ($("#Cname").val().length == 0 || $("#Cdescription").val().length == 0) {
        ...
        $.ajax({
            ...
            url: "http://144.22.56.221:8080/api/Category/save",
...
function actualizarInformacionCategorias(idElemento) {
    ...
    if ($("#Cname").val().length == 0 || $("#Cdescription").val().length == 0) {
        ...
        $.ajax({
            url: "http://144.22.56.221:8080/api/Category/update",
            type: "PUT",
            data: dataToSend,
...
function borrarCategoria(idElemento) {
    ...
    $.ajax({
        url: "http://144.22.56.221:8080/api/Category/" + idElemento,
        type: "DELETE",
        data: dataToSend,
        contentType: "application/JSON",
        datatype: "JSON",
